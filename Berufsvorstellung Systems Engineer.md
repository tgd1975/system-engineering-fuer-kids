...
<img src="Bilder/Dreieck.png" alt="Dreieck" width="150">
...
<img src="Bilder/Schneemann.png" alt="Lösungsbild: ein Gesicht mit Zylinderhut – zwei blaue Augen, eine orange Nase und ein roter, lächelnder Mund" width="150">
...
|---|---|---|---|
| <img src="Bilder/Apfelbaum.png" alt="Baum auf einer Wiese mit roten Äpfeln" width="150"> | <img src="Bilder/Haus.png" alt="Einfaches Haus" width="150"> | <img src="Bilder/Sonne.png" alt="Lächelnde Sonne" width="150"> | <img src="Bilder/Regenbogen.png" alt="Regenbogen mit Wolke" width="150"> |
...
![Karl (Kunde) zeigt auf ein Auto und sagt „Soll hupen!"](Bilder/Use-Case-Diagram.png)
...
![Auto, darunter die Kette: Taster am Lenkrad → (Wird gedrückt) → Steuergerät → (Aktiviert Lautsprecher) → Lautsprecher](Bilder/Dekomposition_Variante_A.png)
...
<img src="Bilder/Karoline.png" alt="Karoline (Technikerin)" width="150">
...
<img src="Bilder/Kevin.png" alt="Kevin (Jurist)" width="150">
...
![Auto, darunter die Kette: Taster am Lenkrad → (Wird gedrückt) → Steuergerät → (Aktiviert Verstärker) → Verstärker → (Lautes Signal) → Lautsprecher](Bilder/Dekomposition_Variante_B.png)
...
![Auto, darunter die Kette: Taster am Lenkrad → (Wird gedrückt) → Computer → (Aktiviert Verstärker) → Verstärker → (Lautes Signal) → Lautsprecher](Bilder/Dekomposition_Variante_C.png)
